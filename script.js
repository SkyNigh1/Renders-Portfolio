...
class Portfolio {
    constructor() {
        this.images = [
            ...
            { id: 3, src: 'img/watch3.png', title: 'Watches Collection', description: 'A stunning collection of luxury watches, showcasing intricate details and craftsmanship.', tags: ['Professional'] },
            { id: 4, src: 'img/Bugatti2.jpg', title: 'Bugatti Close-Up', description: 'A closer look at the details of a Bugatti.', tags: ['Minecraft'] },
            { id: 5, src: 'img/Bugatti3.jpg', title: 'Bugatti Elegance', description: 'Another angle of the stunning Bugatti.', tags: ['Minecraft'] },
            { id: 6, src: 'img/BugattiClouds.png', title: 'Bugatti & Clouds', description: 'A dramatic sky frames the Bugatti perfectly.', tags: ['Minecraft'] },
            { id: 7, src: 'img/CapMail.jpg', title: 'Cap Mail', description: 'Urban architectural capture of Cap Mail.', tags: ['Minecraft'] },
            { id: 8, src: 'img/CapMail2.jpg', title: 'Cap Mail II', description: 'Another perspective on Cap Mail’s modern design.', tags: ['Minecraft'] },
            { id: 9, src: 'img/DarkPoetry.jpg', title: 'Dark Poetry', description: 'An artistic interpretation with a moody tone.', tags: ['Minecraft'] },
            { id: 10, src: 'img/Disney.jpg', title: 'Disney Dreams', description: 'A magical Disney-themed image.', tags: ['Minecraft'] },
            { id: 11, src: 'img/Earth.jpg', title: 'Planet Earth', description: 'A view of our blue planet from space.', tags: ['Sci-Fi'] },
            { id: 12, src: 'img/EyeZoom.png', title: 'Zoom Eye', description: 'Zoomed-in artwork of an eye.', tags: ['Minecraft'] },
            { id: 13, src: 'img/F4G.jpg', title: 'F4G', description: 'A powerful piece of machinery or abstract art.', tags: ['Minecraft'] },
            { id: 14, src: 'img/F4G2.jpg', title: 'F4G II', description: 'Another view of the F4G subject.', tags: ['Minecraft'] },
            { id: 15, src: 'img/FortBoyard.jpg', title: 'Fort Boyard', description: 'The iconic French fortress in the sea.', tags: ['Minecraft'] },
            { id: 16, src: 'img/FortBoyard2.jpg', title: 'Fort Boyard II', description: 'Another angle of Fort Boyard’s structure.', tags: ['Minecraft'] },
            { id: 17, src: 'img/FortBoyard3.jpg', title: 'Fort Boyard III', description: 'Aerial or dramatic view of Fort Boyard.', tags: ['Minecraft'] },
            { id: 18, src: 'img/FortNapoléon.jpg', title: 'Fort Napoléon', description: 'Historic structure captured in detail.', tags: ['Minecraft'] },
            { id: 19, src: 'img/FortNapoléon2.jpg', title: 'Fort Napoléon II', description: 'Second perspective on Fort Napoléon.', tags: ['Minecraft'] },
            { id: 20, src: 'img/Fox.jpg', title: 'The Fox', description: 'Nature meets art with this depiction of a fox.', tags: ['Minecraft'] },
            { id: 21, src: 'img/Goodyear.jpg', title: 'Goodyear Tires', description: 'Symbol of racing and performance.', tags: ['Minecraft'] },
            { id: 22, src: 'img/Guimet.jpg', title: 'Guimet Museum', description: 'A capture of Musée Guimet architecture.', tags: ['Minecraft'] },
            { id: 23, src: 'img/Huayra.jpg', title: 'Pagani Huayra', description: 'Luxury hypercar in motion or on display.', tags: ['Car'] },
            { id: 24, src: 'img/Larressingle.jpg', title: 'Larressingle', description: 'A medieval village with historical charm.', tags: ['Minecraft'] },
            { id: 25, src: 'img/LarressingleFull.jpg', title: 'Larressingle Full View', description: 'Full view of the fortified village.', tags: ['Minecraft'] },
            { id: 26, src: 'img/Lion.jpg', title: 'Lion Portrait', description: 'A majestic lion stares into the lens.', tags: ['Minecraft'] },
            { id: 27, src: 'img/LowPolyFox.jpg', title: 'Low Poly Fox', description: 'A stylized low-poly rendering of a fox.', tags: ['Art'] },
            { id: 28, src: 'img/MaxLananas.jpg', title: 'Max Lananas', description: 'A humorous or character-based artwork.', tags: ['Minecraft'] },
            { id: 29, src: 'img/MiniPlanet.jpg', title: 'Mini Planet', description: '360-degree landscape creating a planet effect.', tags: ['Art'] },
            { id: 30, src: 'img/MirrorCastleSide.jpg', title: 'Mirror Castle Side', description: 'A mirrored architectural structure.', tags: ['Minecraft'] },
            ...
            { id: 33, src: 'img/PontNormandie.jpg', title: 'Pont de Normandie', description: 'An architectural feat in Normandy.', tags: ['Minecraft'] },
            { id: 34, src: 'img/RammsteinWhite.jpg', title: 'Rammstein White', description: 'A high-contrast photo of the band.', tags: ['Minecraft'] },
            { id: 35, src: 'img/Rexy.jpg', title: 'Rexy', description: 'Dinosaur figure in a dramatic setup.', tags: ['Car'] },
            { id: 36, src: 'img/Rexy2.jpg', title: 'Rexy II', description: 'Alternate angle of the dinosaur model.', tags: ['Car'] },
            ...
            { id: 39, src: 'img/SkyNight.jpg', title: 'SkyNight', description: 'Epic night-time landscape or scene.', tags: ['Minecraft'] },
            { id: 40, src: 'img/Statue.jpg', title: 'Statue', description: 'A photograph of an expressive statue.', tags: ['Minecraft'] },
            { id: 41, src: 'img/StatueLumieres.jpg', title: 'Statue of Lights', description: 'Statue illuminated in a festival of lights.', tags: ['Art'] },
            { id: 42, src: 'img/Till.jpg', title: 'Till Lindemann', description: 'Portrait or concert photo of the Rammstein singer.', tags: ['Minecraft'] },
            ...
            { id: 45, src: 'img/dunlop.jpg', title: 'Dunlop Tires', description: 'Racing heritage through tires.', tags: ['Minecraft'] },
            { id: 46, src: 'img/eyeFull.jpg', title: 'The Watcher Beyond', description: 'An organic Minecraft Build of a giant eye.', tags: ['Minecraft'] },
            { id: 47, src: 'img/m4GT3evo.jpg', title: 'M4 GT3 Evo', description: 'BMW’s refined racing machine.', tags: ['Minecraft'] },
            { id: 48, src: 'img/maritécold.jpg', title: 'Marité Cold', description: 'A cold atmosphere surrounds the ship.', tags: ['Minecraft'] },
            { id: 49, src: 'img/maritéhot.jpg', title: 'Marité Hot', description: 'Warm sunset lighting on the ship.', tags: ['Minecraft'] },
            { id: 50, src: 'img/millenium.jpg', title: 'Millenium Tower', description: 'A tall structure reaching the skies.', tags: ['Art'] },
            { id: 51, src: 'img/mirrorCastle.jpg', title: 'Mirror Castle', description: 'Symmetrical and reflective design.', tags: ['Minecraft'] },
            { id: 52, src: 'img/rammsteinRed.jpg', title: 'Rammstein Red', description: 'Fiery red-themed Rammstein photo.', tags: ['Minecraft'] },
            ...
            { id: 56, src: 'img/Bugatti.jpg', title: 'Bugatti Beauty', description: 'A luxury hypercar captured in elegant detail.', tags: ['Minecraft'] },
        ];
